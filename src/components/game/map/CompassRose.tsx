export function CompassRose() {
  return (
    <div
      data-role="compass"
      className="absolute z-10 right-4 top-4 flex flex-col items-center cursor-pointer"
    >
      <svg
        viewBox="0 0 100 100"
        xmlns="http://www.w3.org/2000/svg"
        className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 transition-transform duration-200 hover:scale-125"
      >
        {/* Outer circle */}
        <circle
          cx="50"
      ...
      <div className="mt-1 bg-black/50 text-white text-[10px] sm:text-xs px-1.5 sm:px-2 py-0.5 sm:py-1 rounded whitespace-nowrap">
        Lost?
      </div>
    </div>
  );
